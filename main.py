...
class Layer_Dense:
    ...
    def forward(self, inputs):
        # Save the inputs in the class
        self.inputs = inputs
        # Output the dot product of the inputs with the outputs and the added biases
        # Dot product is ONE value, since we want to reach one value in the end of the calculation
...
# Create an activation function that works with the ReLu principle, so if x > 0 output x, else output 0
